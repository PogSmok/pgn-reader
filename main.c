...
int main(int argc, char* argv[]) {
   ...
   int allNewLines, newLinesBeforeMove[MAX_MOVES] = {};
   char pgnContent[MAX_PGN_SIZE] = {}, tagContent[TAG_COUNT][MAX_TAG_VALUE_LENGTH] = {}, rawMoves[MAX_MOVES][MAX_ALGEBRAIC_LENGTH] = {}, comments[MAX_COMMENT_COUNT][MAX_COMMENT_LENGTH] = {}, moveString[MAX_PGN_SIZE];
